                ...
                <div class="col-xl-4">
                    <div class="datospersonales">
                        <form method="post" action="Usuario">
                            ...
                            <input type="text" placeholder="" name="textusuario"><br><br>
                            <h2><label>Contraseña</label><br></h2>
                            <input type="password" placeholder="" name="textclave"><br><br><br>
                            <h1>Asignar usuario</h1><br>
                            <h2><label>Nombre Docente</label><br></h2>
                            <input type="text" placeholder="" name=""><br><br>
                            <h2><label>Numero documento</label><br></h2>
                            <input type="text" placeholder="" name="datosnumeroid"><br><br> 
